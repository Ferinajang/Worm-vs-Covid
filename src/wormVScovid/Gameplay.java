...
public class Gameplay extends JPanel implements KeyListener,ActionListener {
	...
	public void paint(Graphics g) {
		...
		// title image
		titleImage = new ImageIcon("res/titlesnake.gif");
		...
		bgImage = new ImageIcon("res/bg.png");
		...
		// head another position
		for(int a = 0 ; a < lengthofsnake;a++) {
			if(a == 0 && right) {
				rightMouth = new ImageIcon("res/rightmouthpng");
